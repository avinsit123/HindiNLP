...
class classifier():
    ...
    def train(self,train_dict,dest_path='resources/taggers/classifiers'):
    ...
    def Plot_Weights(self,dest_path='resources/taggers/classifiers'):
        plotter = Plotter()
        plotter.plot_weights(dest_path+"/weights.txt")
        
    def Predict(input_text,dest_path='resources/taggers/classifiers'):
