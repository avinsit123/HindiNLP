...
setup(
  name = 'HindiNLPTools',         # How you named your package folder (MyLib)
  packages = ['HindiNLPTools'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/avinsit123/HindiNLPTools/archive/v2.0.tar.gz',    # I explain this later on
  ...
  classifiers=[
    ...
    'Intended Audience :: NLP-Enthusiasts',      # Define that your audience are developers
